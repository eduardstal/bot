...
from tg_bot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, STRICT_GBAN, LOGGER
...
def gbanlist(bot: Bot, update: Update):
    ...
    if not banned_users:
        update.effective_message.reply_text("There aren't any gbanned users!")
        return

    banfile = 'Banned globally: \n'
...
def check_and_ban(update, user_id, should_message=True):
    if sql.is_user_gbanned(user_id):
        ...
        if should_message:
            update.effective_message.reply_text("This user is gbanned.")
