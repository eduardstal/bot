...
def import_data(bot: Bot, update):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        try:
            ...
            msg.reply_text("Try downloading and reuploading the file as yourself before importing")
            return
        ...
        try:
            ...
            msg.reply_text("An exception occured while restoring your data. The process may not be complete. If "
                           "you're having issues with this, message @eduardstal with your backup file so the "
