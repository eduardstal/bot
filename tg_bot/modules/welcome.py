    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text("Bot owner has joined the group!")
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text("Bot owner has left the group!")
                return
...
def welcome(bot: Bot, update: Update, args: List[str]):
    ...
    if len(args) == 0 or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text("Welcome message enabled!")

        elif args[0].lower() in ("off", "no"):
            sql.set_welc_preference(str(chat.id), False)
            update.effective_message.reply_text("Welcome message disabled!")
...
def goodbye(bot: Bot, update: Update, args: List[str]):
    ...
    if len(args) == 0 or args[0] == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text("Goodbye message enabled!")

        elif args[0].lower() in ("off", "no"):
            sql.set_gdbye_preference(str(chat.id), False)
            update.effective_message.reply_text("Goodbye message disabled!")
...
WELC_HELP_TXT = "Easter egg 5".format(dispatcher.bot.username)
